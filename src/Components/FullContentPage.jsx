...
const imagePath = import.meta.env.VITE_IMAGE_PATH || '/images/';
...
export default function FullContentPage() {
  ...
  if (!content) {
    return (
      <div className="mx-6 md:mx-[50px] lg:mx-[100px] xl:mx-[200px] my-10 text-center">
        <h1 className="text-2xl font-semibold text-red-500">Content Not Found</h1>
        <p className="text-lg text-gray-700 mt-4">The requested blog content does not exist.</p>
      </div>
    );
  }
  ...
  return (
    <div className="mx-6 md:mx-[50px] lg:mx-[100px] xl:mx-[200px] my-10">
      {/* Title */}
      <h1 className="text-[28px] md:text-[32px] lg:text-[40px] font-medium text-[#1B1B1F]">
      ...
      <div className="flex justify-between flex-col md:flex-row my-4 md:m-4 gap-2">
        ...
        <div>
          <button className="flex bg-[#EAEAEA] text-[16px] md:text-[20px] font-normal px-2 md:px-4 py-2">
            <CgWebsite className="m-1" />
            Go to Source
          </button>
        </div>
      </div>
      ...
      <p className="text-base md:text-lg text-[#1B1B1F] leading-7">
        Uncontrolled diabetes increases the risk of hearing loss due to the damage high blood sugar causes to blood vessels and nerves essential for hearing. Despite this, hearing health is rarely prioritised in...
      </p>
      <p className="text-base md:text-lg text-[#1B1B1F] my-4 leading-7">
        Stating that access to holistic diabetes care is crucial to address the overlooked link between diabetes and hearing loss, a condition affecting several diabetics worldwide, Dr. Rajesh Kesari, executive council member, Research Society for Study of Diabetes in India, Delhi Chapter, says that there is a close relationship between diabetes and hearing loss...
      </p>
